...
XCodecParameters_sp new_XAVCodecParameters(const AVCodecContext *,const AVRational & = {1,1}) noexcept(false);
XCodecParameters_sp new_XAVCodecParameters(const AVCodecParameters *,const AVRational & = {1,1}) noexcept(false);
