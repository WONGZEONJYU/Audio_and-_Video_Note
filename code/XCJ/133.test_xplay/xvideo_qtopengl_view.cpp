...
#endif
    show();
    m_player_.Open("/Volumes/500G/v1080.mp4",{},true);
    const auto vp{m_player_.get_video_params()};
    Init(*vp);
    m_player_.Start();
    m_timer_id_ = startTimer(10);
}
...
void XVideoWidget::timerEvent(QTimerEvent *event) {
